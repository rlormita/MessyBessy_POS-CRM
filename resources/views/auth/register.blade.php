                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group {{ $errors->has('terms') ? ' has-error' : '' }}">
                            ...
                            I understand and agree to the <a href='https://www.facebook.com/messybessycleaners'>Terms & Conditions </a> and <a href='https://www.facebook.com/messybessycleaners'> Privacy Policy </a>.
                            </center>
